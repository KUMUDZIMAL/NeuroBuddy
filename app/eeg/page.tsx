...
// FIX: Rename 'History' to 'HistoryIcon' to avoid JSX/TypeScript conflict
import { Upload, BrainCircuit, History as HistoryIcon, Zap, Activity, ShieldCheck, TrendingUp, TrendingDown } from "lucide-react";
...
export default function EEG() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const properDate = formatDateTime(new Date()); // Clean format generated here
